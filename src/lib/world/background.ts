...
export function renderBackground(game: GameType): void {
      ...
      row.forEach((tile, j) => {
        ...
        if (tile.bg) {
          game.ctx.drawImage(
            ...
            16,
            16,
            roomWidth * up.iX + (tileWidth * (j + 1) - tileWidth),
            roomHeight * up.iY + (tileHeight * (i + 1) - tileHeight),
            tileWidth,
            tileHeight
          );
        }
      ...
      row.forEach((tile, j) => {
        ...
        if (tile.bg) {
          game.ctx.drawImage(
            ...
            16,
            16,
            roomWidth * down.iX + (tileWidth * (j + 1) - tileWidth),
            roomHeight * down.iY + (tileHeight * (i + 1) - tileHeight),
            tileWidth,
            tileHeight
          );
        }
      ...
      row.forEach((tile, j) => {
        ...
        if (tile.bg) {
          game.ctx.drawImage(
            ...
            16,
            16,
            roomWidth * left.iX + (tileWidth * (j + 1) - tileWidth),
            roomHeight * left.iY + (tileHeight * (i + 1) - tileHeight),
            tileWidth,
            tileHeight
          );
        }
      ...
      row.forEach((tile, j) => {
        ...
        if (tile.bg) {
          game.ctx.drawImage(
            ...
            16,
            16,
            roomWidth * right.iX + (tileWidth * (j + 1) - tileWidth),
            roomHeight * right.iY + (tileHeight * (i + 1) - tileHeight),
            tileWidth,
            tileHeight
          );
        }
    ...
    row.forEach((tile, j) => {
      if (tile.bg) {
        ...
        game.ctx.drawImage(
          ...
          16,
          16,
          roomWidth * game.state.currentRoom.x + (tileWidth * (j + 1) - tileWidth),
          roomHeight * game.state.currentRoom.y + (tileHeight * (i + 1) - tileHeight),
          tileWidth,
          tileHeight
        );
      }
